...
import { getProductBySlug, getProductsByCategory, formatPrice } from "@/data/products.js";
          ...
          <section className={styles.related}>
            <div className={styles.inner}>
              ...
              <div className={styles.relatedGrid}>
                {related.map((p) => (
                  <Link key={p.slug} href={`/san-pham/${p.slug}`} className={styles.relatedCard}>
                    <div className={styles.relatedImg}>
                      <Image src={p.image} alt={p.name} fill style={{ objectFit: "cover" }} />
                    </div>
                    <div className={styles.relatedBody}>
                      <p className={styles.relatedName}>{p.name}</p>
                      <strong className={styles.relatedPrice}>{formatPrice(p.price)}</strong>
                    </div>
                  </Link>
                ))}
              </div>
